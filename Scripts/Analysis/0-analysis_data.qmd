...
```{r}
d <- d %>% 
  filter(year %in% as.character(2002:2017)) %>% 
...
# Note - in USAID data 0 instances of US military health reported 2000:2003, 3 in 2004
#        and 40 in 2005. So, subsetting model data starting 2005.
#        This will apply to all models for maximum comparability.
d <- d %>% filter(year >= 2005)

# Drop NA values on variables used in all models (note - these 3 suffice to
