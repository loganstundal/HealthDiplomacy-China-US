...
Rename variables and create military health indicators.
...
d <- d %>%   
  mutate(
    ...
    ghdx_ncd_prevalence_pc = (ghdx_ncd_prevalence / un_pop),
    ghdx_cmd_prevalence_pc = (ghdx_cmd_prevalence / un_pop),
    emdat_deaths_total     = (emdat_deaths_total / un_pop),
...
```{r}
#| message: false # suppress attachment notice
